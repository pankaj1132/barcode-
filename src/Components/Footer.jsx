      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex flex-col space-y-8 lg:grid lg:grid-cols-4 lg:gap-8 lg:space-y-0">
          ...
          <div>
            ...
            <div className=' w-16 lg:w-20 h-0.5 bg-blue-600 mb-3.5'></div>
            <ul className="text-gray-300 text-xs lg:text-sm space-y-1 lg:space-y-1.5 mb-6">
              <li className="hover:text-blue-400 cursor-pointer transition-colors">
                About Us
              </li>
              <li className="hover:text-blue-400 cursor-pointer transition-colors">
            ...
            {/* Social Media */}
            <div>
              <h4 className="text-white font-semibold mb-3 text-sm lg:text-base">Follow Us</h4>
              <div className="flex space-x-2">
                <a href="#" className="w-8 h-8 lg:w-10 lg:h-10 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors">
                  <svg className="w-3.5 h-3.5 lg:w-5 lg:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="w-8 h-8 lg:w-10 lg:h-10 bg-green-600 rounded-full flex items-center justify-center hover:bg-green-700 transition-colors">
                  <svg className="w-3.5 h-3.5 lg:w-5 lg:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
